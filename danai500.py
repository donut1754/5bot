...
#--------===---====--------------
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"แสดงลิ้งเชิญกลุ่ม\nline://ti/g/" + gurl)
                else:
                    if wait["lang"] == "JP":
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["กุ๊กๆๆๆๆๆ","binla:on","Binla:On"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["ชิ้วๆๆๆๆๆ","binla:bey","Binla:Bye"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
